...
def downsampleTarget(alleleDict_file, target_input, numTargets, output_alleleDict, use_bed=False):
    '''
...
def main():
    ...
    downsampleTarget(args.alleleDict_file, target_input, args.numTargets, args.output_alleleDict, use_bed)
